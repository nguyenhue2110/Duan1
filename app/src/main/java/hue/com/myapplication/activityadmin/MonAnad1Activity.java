            ...
            public void uploadDaTatoFirebase(){
                if(mFilePathUri != null){
                    ...
                    if(edtTenMA.getText().toString().isEmpty()){
                        Toast.makeText(MonAnad1Activity.this, "Tên Món Ăn Không bỏ trống", Toast.LENGTH_SHORT).show();
                    } else if (edtGiaBanma.getText().toString().isEmpty()) {
                        Toast.makeText(MonAnad1Activity.this, "Giá Không Bỏ Trống", Toast.LENGTH_SHORT).show();
                    }else {
                    ...
                    Toast.makeText(MonAnad1Activity.this, "please select...", Toast.LENGTH_SHORT).show();
                }
            }
//            public void showid() {
...
//        });
    ...
    public void loadma(String categoriid){
        ...
        FirebaseRecyclerAdapter<Food, RecyclerView_MonAnad> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Food, RecyclerView_MonAnad>(options) {
            @Override
            protected void onBindViewHolder(@NonNull RecyclerView_MonAnad holder, int position, @NonNull Food model) {
            ...
            public RecyclerView_MonAnad onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_adma, parent, false);
                ...
                viewholder.setOnClickListener(new RecyclerView_MonAnad.ClickListener() {
                    ...
                    public void onItemLongClick(View view, int postion) {
                        ...
                        btnOKma.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if (edtTenMA.getText().toString().isEmpty()){
                                    Toast.makeText(MonAnad1Activity.this, "Tên Không Bỏ Trống", Toast.LENGTH_SHORT).show();
                                }else if (edtGiaBanma.getText().toString().isEmpty()){
                                    Toast.makeText(MonAnad1Activity.this, "Giá Không Bỏ Trống", Toast.LENGTH_SHORT).show();
                                }else {
                                    beginUpdate();
    ...
    public void showdeleteDialog(final String foodid,final String categorid,final String foodname,final int price,final String foodimage){
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                mquery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(MonAnad1Activity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
