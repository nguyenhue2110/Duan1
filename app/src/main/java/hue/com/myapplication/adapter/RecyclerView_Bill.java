...
public class RecyclerView_Bill extends RecyclerView.ViewHolder {
    ...
    public void setBill(Context context, String billid, String date, String address, String payments, String state, int total, String username) {
